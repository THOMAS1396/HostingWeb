...
def run_quiz():
    ...
    print("\nInstructions: Choose the correct answer by")
    print("typing A, B, C, or D and pressing Enter.\n")
    ...
    if percentage >= 80:
        ...
        print("C - Average. Keep Practicing! 📚")
    else:
        print("D - Needs Improvement. Don't Give Up! 💪")
